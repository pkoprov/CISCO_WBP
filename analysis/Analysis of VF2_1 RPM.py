...
datafr1 = pd.read_csv("../data/VF-2_1 wTool/2022_01_07 13-12-25_VF-2-1_with tool.csv", names=colnames, skiprows=1)
datafr2 = pd.read_csv("../data/VF-2_1 wTool/2022_01_07 13-12-55_VF-2-1_with tool (not moving).csv", names=colnames, skiprows=1)
